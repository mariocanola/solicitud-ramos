...
apa_table(9, 'Especificación de requisitos funcionales del sistema',
    ...
    [
        ...
        ['RF-13','Restricción de período por beneficiario','Verificar que el beneficiario no tenga solicitud activa en el período vigente','Solicitudes','Alta'],
...
usecase_table('CU-01 — Crear Solicitud (Empleado / Operador)', [
    ...
    ('Flujo alternativo C', 'Si el empleado ya realizó una solicitud en el período vigente: el sistema muestra la solicitud activa existente e impide registrar una nueva'),
